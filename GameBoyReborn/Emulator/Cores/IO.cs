...
namespace Emulator
{
    public class IO
    {
        ...
        public void Write(byte at, byte b)
        {
            ...
            else if (at == 0x20) APU.CH3_WriteNR41((byte)(b | 0xC0));
            else if (at == 0x21) APU.CH3_WriteNR42(b);
            else if (at == 0x22) APU.CH3_WriteNR43(b);
            else if (at == 0x23) APU.CH3_WriteNR44((byte)(b | 0x3F));
